            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($editMode)
                            <button type="button" class="btn btn-primary" wire:click="updateState">Update</button>
                        @else
                            <button type="button" class="btn btn-primary" wire:click="storeState">Store</button>
                        @endif
                    </div>
                </div>
            </div>
